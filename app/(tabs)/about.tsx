      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Card>
          ...
          <Text style={{ color: colors.textSecondary, lineHeight: 22 }}>
            Shri Shirdi Sai Mandir is a spiritual community dedicated to
            spreading the teachings and philosophy of Shri Sai Baba of Shirdi
            through devotion, service, and community engagement. Through
            temples, Sai Palkhi processions, spiritual programs, and
            philanthropic initiatives across the United States, the organization
            fosters spiritual growth, family values, compassion, and selfless
            service while inspiring individuals to recognize the divinity within
